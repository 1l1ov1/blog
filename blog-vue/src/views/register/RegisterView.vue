...
const submitForm = async () => {
    const formDate = InputType.value === 'username' ? await usernameFormRef.value.getFormDate() : await phoneFormRef.value.getFormDate();
    if (formDate) {
        let form = {
            ...formDate,
...
<template>
    <div class="container">
        <div class="form-box">
            ...
            <!-- 用户名登录 -->
            <UsernameForm ref="usernameFormRef" :InputType="InputType" />

            <!-- 手机登录 -->
            <PhoneForm ref="phoneFormRef" :InputType="InputType" />
